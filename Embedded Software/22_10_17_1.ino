...
// 모터 속도 관련 변수 설정
int motorSpeed; // 스텝 사이의 자연시간으로서 4500~1000의 범위를 갖는다.
int motorSpeedPercent; // 속도를 0~100%로 나타낸다.

// 스텝 모터의 스텝 설정
// 0~7은 동작 신호, 8번째는 모터 경시지 신호
