...
a = pathlib.Path(__file__).parent.absolute() # pathlib은 언제 어디서나 같은 폴더면 어디에서나 적용 가능하게 사용했습니다. 이 코드는 현 위치를 뜻합니다.
a1 = '{}\\replacement_input.txt'.format(a)  # 추가로 파일 이름까지 입력하면 준비 완료입니다.
    ...
    if i % 2 == 0 : 
        ...
        while 1 : 
            ...
            try : 
                ...
                try :
                    File_content.append(buffer[0]) # buffer[buffer_start_number]가 없는 값일 때 시도됩니다. 1차 예외이고, 이후 예외는 102번 줄에 기입했습니다.
